      ...
      {draft ? (
        ...
        <div className="flex items-end gap-2">
          ...
          <textarea
            ...
            className={cn(
              "flex-1 resize-none rounded-xl border border-border bg-muted px-4 py-2.5 text-sm text-foreground placeholder-muted-foreground outline-none transition-colors focus:border-primary/50 scrollbar-styled",
